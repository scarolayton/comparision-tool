...
credentials = service_account.Credentials.from_service_account_file('./comparison-tool-405701-b1a0581c92c2.json')
project_id = 'comparison-tool-405701'
...
class GoogleDataSetView(viewsets.ModelViewSet):
  ...
  def fetch_for_specific_date(self, request):
    ...
    where_clause = f"""
        ...
        AND refresh_date BETWEEN '{first_date}' and '{second_date}'
